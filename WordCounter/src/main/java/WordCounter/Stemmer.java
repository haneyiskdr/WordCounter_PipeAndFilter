...
{  private char[] base;
    ...
    {  char[] new_b = new char[o+INC];
        for (int c = 0; c < o; c++) new_b[c] = base[c];
        base = new_b;
    }
        base[o++] = ch;
    }
    ...
    {  char[] new_b = new char[o+wLen+INC];
        ...
        for (int c = 0; c < wLen; c++) base[o++] = w[c];
    }
     ...
     */
    public String toString() { return new String(base,0,o_end); }

    /**
     * Returns the length of the word resulting from the stemming process.
     */
    public int getResultLength() { return o_end; }
     ...
     */
    public char[] getResultBuffer() { return base; }
